...
bool BuildOfferAcceptJson(const COffer& theOffer, const CAliasIndex &alias, const CTransaction &aliastx, UniValue& oOfferAccept, const std::vector<unsigned char> &vchPrivKey=std::vector<unsigned char>());
bool BuildOfferJson(const COffer& theOffer, const CAliasIndex &alias, const CTransaction &aliastx, UniValue& oOffer, const std::vector<unsigned char> &vchPrivKey=std::vector<unsigned char>());
#endif // OFFER_H
