...
void MyAcceptedOfferListPage::on_ackButton_clicked()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm Payment Acknowledgement"),
         tr("Warning: By acknowledging this payment the offer quantity will be adjusted by the amount requested by the buyer. If you are shipping an item to the buyer please communicate a tracking number to the buyer via a syscoin message.") + "<br><br>" + tr("Are you sure you wish to acknowledge this payment?"),
