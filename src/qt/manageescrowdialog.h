...
public:
	...
	bool loadEscrow(const QString &escrow, QString &buyer, QString &seller, QString &reseller, QString &arbiter, QString &status, QString &total, QString &exttxid, QString &paymentOption, QString &redeemtxid);
