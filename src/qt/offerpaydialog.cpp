	...
	ui(new Ui::OfferPayDialog)
{
	...
	ui->payMessage->setText(QString("<p>") + tr("You've created an escrow for") + QString(" %1 ").arg(quantity) + tr("of") + QString(" '%1' ").arg(title) + tr("for") + QString(" %3 %4 ").arg(price).arg(currency) + QString("</p><p><font color='green'><b>") + tr("Your payment is in escrow!") + QString("</b></font></p><p>") + tr("The merchant has been sent your delivery information and your item should arrive shortly. The merchant may follow-up with further information through a private message (please check your inbox regularly).") + QString("</p><br>"));				
